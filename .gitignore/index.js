...
client.on('message', function (message) {
  let msgauthor = message.author
    ...
    if (!message.author.bot || !message.author.id == '309057806219083776') if (message.content.includes("https://discord.gg/") || message.content.includes("https://discordapp.com/invite/")) try {message.author.send("Vous n'avez pas l'autorisation de poster des liens vers d'autres discord."), message.delete()} catch (error) {console.log(error)}
})
